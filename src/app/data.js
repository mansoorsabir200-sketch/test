export const HERO_CONTENT =
  "  I am Mansoor Sabir, a passionate Full Stok Web Devloper from Afghanistan. I love solving real-worlds  problems through technology and building things that truly help pepole.  My focus is on creating modren, Responsive, and user Freindly websites for individuals and businesses. Every line of code I write is a step toward innovation, creativity, and making life easier for others.   ";

export const ABOUT_TEXT =
  "hgeurg hgeg hgoergigh pih fbhoeu ibheor pihor pihgwo plihfgreo pishgwr pijs pisgh piskg pisug p;iskg p;iskrg piuipi pu puirg8r uosg ";

export const EXPEIENCES = [
  {
    year: " 2025-present",
    role: " teacher student",
    compeny: "jamal tech",
    Description:
      "text  text texttext texttext texttext text text text text text vtext text text text",
    technologies: ["HTML", "CSS", "JS", "REACTE"],
  },
  {
    year: " 2025-present",
    role: " teacher student",
...
export const CONTACT = {
  ...
  phone: " 0700267728",
  email: "mansoorsabir@654gmail.com",
};
